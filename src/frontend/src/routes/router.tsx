...
export const ErrorPage = Loadable(lazy(() => import('@components/shared/errors/ErrorPage')));
...
export const UserDetail = Loadable(
  lazy(() => import('@containers/core-user'))
);
...
export const NotFound = Loadable(
  lazy(() => import('@containers/not-found'))
);
