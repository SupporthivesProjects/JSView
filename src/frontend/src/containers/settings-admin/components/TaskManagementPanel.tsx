...
import { FactCollection } from '@components/shared/settings/FactCollection';
import { Loadable } from '@helpers/loading';
import { useInstance } from '../../../hooks/UseInstance';
import FailedTasksTable from '@components/tables/settings/FailedTasksTable';
import PendingTasksTable from '@components/tables/settings/PendingTasksTable';

const ScheduledTasksTable = Loadable(
  lazy(() => import('@components/tables/settings/ScheduledTasksTable'))
);
