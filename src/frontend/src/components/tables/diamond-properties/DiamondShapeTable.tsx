...
import { diamondShapeFields } from "../../forms/CommonForms";
import {
...
export default function DiamondShapeTable() {
  ...
  // --- Create modal ----------------------------------------------------
  const newDiamondShape = useCreateApiFormModal({
    url: ApiEndpoints.diamond_shape_list,
  ...
  const editDiamondShape = useEditApiFormModal({
    url: ApiEndpoints.diamond_shape_list,
    pk: selectedDiamondShape,
    ...
    return [
      {
        name: "active",
        label: t`Active`,
        description: t`Show active diamond shape`,
        type: "boolean",
      },
    ];
  }, []);
  ...
  return (
    <>
      {newDiamondShape.modal}
      {editDiamondShape.modal}
      {deleteDiamondShape.modal}
      <InvenTreeTable
        url={apiUrl(ApiEndpoints.diamond_shape_list)}
        tableState={table}
        columns={columns}
        props={{
