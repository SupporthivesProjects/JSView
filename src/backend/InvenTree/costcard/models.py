...
class CostCardStoneLineMixin(CardsFieldsMixin):
    ...
    default_rate = models.CharField(max_length=3, choices=[('yes', _('Yes')), ('no', _('No'))], default='no', verbose_name=_('D.R.'), help_text=_('Yes if rate is found for stone, shape, and MM size.'))
